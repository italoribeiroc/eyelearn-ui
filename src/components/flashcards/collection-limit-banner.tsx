...
/** Shown once a free-plan user hits FREE_COLLECTION_LIMIT (see flashcards/services.py on the backend). */
export async function CollectionLimitBanner() {
  const [t, tBilling, tPlans] = await Promise.all([
    getTranslations("flashcards.limit"),
