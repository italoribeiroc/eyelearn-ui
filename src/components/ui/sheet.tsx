...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-0 bg-surface shadow-[var(--shadow-soft-lg)] outline-none data-open:animate-in data-closed:animate-out data-closed:duration-200 data-open:duration-300",
  {
    variants: {
      side: {
        right:
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-full p-1.5 text-foreground-muted opacity-80 outline-none transition-colors hover:bg-muted hover:text-foreground hover:opacity-100 focus-visible:ring-3 focus-visible:ring-ring/50"
          >
